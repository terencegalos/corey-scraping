...
class Scraper18:
    def __init__(self):
        ...
        self.url = 'chooseadv.com'
        self.table_name = 'scraper18_info'
    ...
    def scrape_with_names(self,batch_size=10,num_threads=3):
        ...
        names_generator = name_generator.generate_names('aisha','eyrich')#'/root/projects/corey/src/scraping/CommonFirstandLast.xlsx','David','DAVIS')
