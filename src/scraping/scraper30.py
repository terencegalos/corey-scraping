...
class Scraper30:
    def __init__(self):
        ...
        self.url = 'getmyadv.com'
        self.table_name = 'scraper30_info'
    ...
    def scrape_with_names(self,batch_size=10,num_threads=3):
        ...
        names_generator = name_generator.generate_names('aabia','molinas')#'/root/projects/corey/src/scraping/CommonFirstandLast.xlsx','David','DAVIS')
