...
class Scraper39:
    def __init__(self):
        ...
        self.url = 'grtdebt.com'
        self.table_name = 'scraper39_info'
    ...
    def scrape_with_names(self,batch_size=10,num_threads=3):
        ...
        names_generator = name_generator.generate_names('aisya','thomasson')#'/root/projects/corey/src/scraping/CommonFirstandLast.xlsx','David','DAVIS')
