...
class Scraper8:
    def __init__(self):
        ...
        self.url = 'advdebt.com'
        self.table_name = 'scraper8_info'
    ...
    def scrape_with_names(self,batch_size=10,num_threads=3):
        ...
        names_generator = name_generator.generate_names('ajahnae','wagenaar')#'/root/projects/corey/src/scraping/CommonFirstandLast.xlsx','David','DAVIS')
        # print(names)
