...
class Scraper15:
    def __init__(self):
        ...
        self.url = 'calladvnow.com'
        self.table_name = 'scraper15_info'
    ...
    def scrape_with_names(self,batch_size=10,num_threads=3):
        ...
        names_generator = name_generator.generate_names('cherryley','ashbir')#'/root/projects/corey/src/scraping/CommonFirstandLast.xlsx','David','DAVIS')
