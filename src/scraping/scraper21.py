...
class Scraper21:
    def __init__(self):
        ...
        self.url = 'getadvnow.com'
        self.table_name = 'scraper21_info'
    ...
    def scrape_with_names(self,batch_size=10,num_threads=3):
        ...
        names_generator = name_generator.generate_names('aitza','wertz')#'/root/projects/corey/src/scraping/CommonFirstandLast.xlsx','David','DAVIS')
