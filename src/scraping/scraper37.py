...
class Scraper37:
    def __init__(self):
        ...
        self.url = 'gowithadv.com'
        self.table_name = 'scraper37_info'
    ...
    def scrape_with_names(self,batch_size=10,num_threads=3):
        ...
        names_generator = name_generator.generate_names('aisma','tees')#'/root/projects/corey/src/scraping/CommonFirstandLast.xlsx','David','DAVIS')
