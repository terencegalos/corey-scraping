...
from scraping import get_city_by_zip

class Scraper32:
    def __init__(self):
        
        self.url = 'getnsc.com'
        self.table_name = 'scraper32_info'
    ...
    def scrape_with_names(self,batch_size=10,num_threads=3):
        ...
        names_generator = name_generator.generate_names('aivils','zoucha')#'/root/projects/corey/src/scraping/CommonFirstandLast.xlsx','David','DAVIS')
