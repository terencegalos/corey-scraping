...
class Scraper50:
    ...
    def scrape_with_refcodes(self, batch_size=10, last_interrupt_char='A', last_interrupt_debtor=None,searchby_start=1,starting_page=1): # starting page is a dummy and is always 1
