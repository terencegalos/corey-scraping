...
class Scraper29:
    def __init__(self):
        ...
        self.url = 'getidsnow.com'
        self.table_name = 'scraper29_info'
    ...
    def scrape_with_names(self,batch_size=10,num_threads=3):
        ...
        names_generator = name_generator.generate_names('aabidammar','welchel')#'/root/projects/corey/src/scraping/CommonFirstandLast.xlsx','David','DAVIS')
