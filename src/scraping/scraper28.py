...
class Scraper28:
    def __init__(self):
        ...
        self.url = 'getgwf.com'
        self.table_name = 'scraper28_info'
    ...
    def scrape_with_names(self,batch_size=10,num_threads=3):
        ...
        names_generator = name_generator.generate_names('aishlin','duponte')#'/root/projects/corey/src/scraping/CommonFirstandLast.xlsx','David','DAVIS')
