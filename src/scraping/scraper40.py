...
class Scraper40:
    def __init__(self):
        ...
        self.url = 'letstryadv.com'
        self.table_name = 'scraper40_info'
    ...
    def scrape_with_names(self,batch_size=10,num_threads=3):
        ...
        names_generator = name_generator.generate_names('aiswarya','torivio')#'/root/projects/corey/src/scraping/CommonFirstandLast.xlsx','David','DAVIS')
        results = []
