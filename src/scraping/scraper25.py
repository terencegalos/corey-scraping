...
class Scraper25:
    def __init__(self):
        ...
        self.url = 'getbtf.com'
        self.table_name = 'scraper25_info'
    ...
    def scrape_with_names(self,batch_size=10,num_threads=3):
        ...
        names_generator = name_generator.generate_names('aison','wertman')#'/root/projects/corey/src/scraping/CommonFirstandLast.xlsx','David','DAVIS')
