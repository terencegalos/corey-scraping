...
class Scraper35:
    def __init__(self):
        ...
        self.url = 'goadvtoday.com'
        self.table_name = 'scraper35_info'
    ...
    def scrape_with_names(self,batch_size=10,num_threads=3):
        ...
        names_generator = name_generator.generate_names('aiswarya','singleton')#'/root/projects/corey/src/scraping/CommonFirstandLast.xlsx','David','DAVIS')
