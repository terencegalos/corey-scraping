...
class Scraper23:
    def __init__(self):
        ...
        self.url = 'getadvtoday.com'
        self.table_name = 'scraper23_info'
    ...
    def scrape_with_names(self,batch_size=10,num_threads=3):
        ...
        names_generator = name_generator.generate_names('aislynne','schenck')#'/root/projects/corey/src/scraping/CommonFirstandLast.xlsx','David','DAVIS')
