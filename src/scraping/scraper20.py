...
class Scraper20:
    def __init__(self):
        ...
        self.url = 'getadvloan.com'
        self.table_name = 'scraper20_info'
    ...
    def scrape_with_names(self,batch_size=10,num_threads=3):
        ...
        names_generator = name_generator.generate_names('alenis','zarlingo')#'/root/projects/corey/src/scraping/CommonFirstandLast.xlsx','David','DAVIS')
