...
class Scraper38:
    def __init__(self):
        ...
        self.url = 'gowithunited.com'
        self.table_name = 'scraper38_info'
    ...
    def scrape_with_names(self,batch_size=10,num_threads=3):
        ...
        names_generator = name_generator.generate_names('aisya','wayne')#'/root/projects/corey/src/scraping/CommonFirstandLast.xlsx','David','DAVIS')
