...
class Scraper24:
    def __init__(self):
        ...
        self.url = 'getbenefit1st.com'
        self.table_name = 'scraper24_info'
    ...
    def scrape_with_names(self,batch_size=10,num_threads=3):
        ...
        names_generator = name_generator.generate_names('aislyn','wierenga')#'/root/projects/corey/src/scraping/CommonFirstandLast.xlsx','David','DAVIS')
